...
class MainViewController: UIViewController {
    ...
    private func setupCollection() {
        ...
        NSLayoutConstraint.activate([
            ...
            navigationCollection.leadingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.leadingAnchor),
            navigationCollection.trailingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.trailingAnchor),
    ...
    private func setupLogoImage() {
        ...
        NSLayoutConstraint.activate([
            ...
            logoImage.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 20),
            logoImage.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -20),
